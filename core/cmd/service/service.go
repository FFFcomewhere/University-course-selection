...
import (
	...
	http "University-course-selection/http_cli/pkg/http"
...
var fs = flag.NewFlagSet("http_cli", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "http_cli")
